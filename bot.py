...
КРИТЕРИИ ОЦЕНКИ:
1. Качество кода и решения 
2. Полнота и правильность реализации 
3. Документация и комментарии 
4. Оформление и структура работы 
5. Качество результатов и выводов работы 
...
- Поставь итоговую оценку (отлично, хорошо, удовлетворительно, неудовлетворительно)
